...
check_histogram = st.checkbox("Histogram visualization", value=False)

check_explore = st.button("explore")
    ...
    for folder in os.listdir(compact_path):
        ...
        for source_fit in os.listdir(sample_folder):
            ...
            with minmax_column:
                ...
                st.write(source_fit)
                st.image(image=npy_image_minmax, width=128)
    ...
    for folder in os.listdir(extended_path):
        ...
        for source_fit in os.listdir(sample_folder):
            ...
            with minmax_column:
                ...
                st.write(source_fit)
                st.image(npy_image_minmax, width=128)
