...
@dataclass
class DataBase:
    """Class for of database configuration and analysis"""
...
class RadioDB(DataBase):
    compact_folder:         str = "compact"
    extended_folder:        str = "extended"
    multi_island_folder:    str = "extended-multiisland"
